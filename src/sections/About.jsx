...
function About(){
    return(
        <section id="about" className="min-h-screen bg-[#0F111A] lg:pb-24 relative flex flex-col justify-center lg:grid place-items-center lg:grid-cols-3 bg-transparent backdrop-blur-md gap-20 lg:gap-2 overflow-hidden">
            ...
            <div className="lg:col-span-2 flex flex-col justify-center items-center lg:items-start px-8 lg:px-0 lg:pr-12">
                <p className="text-white text-xl md:text-2xl lg:text-2xl text-center md:text-left lg:text-left">Frontend Developer focused on UI/UX & clean interfaces</p>
                <hr className="w-full border-0 border-t-2 border-white my-2"/>
                <ul className="list-disc list-inside md:list-outside lg:list-outside text-md md:text-xl lg:text-xl text-white px-6 lg:px-2">
